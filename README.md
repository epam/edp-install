...
* Add edp-deploy-role role to EDP service account: 
...
### Install EDP
* Choose your edp name, for ex. "demo" and create namespace <your_edp_name>-edp-cicd. In our example - "demo-edp-cicd".
* Create service account edp in namespace <your_edp_name>-edp-cicd
...
* Deploy operators in the <your_edp_name>-edp-cicd namespace by following the correspondent instructions in their repositories:
