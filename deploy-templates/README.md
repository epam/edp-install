...
| argocd.oidcSecretName | string | `""` | ArgoCD OIDC client secret. Provide existing secret name or leave empty to be generated by Keycloak Operator |
...
| global.version | string | `"3.3.0"` | EDP version |
